...
import { useLazyGetOrdersByUserQuery, useUpdateStatusOrderMutation } from '../../../features/Cart/cartApi.service';
...
function TableOrder() {
  const [getOder, resultOder] = useLazyGetOrdersByUserQuery();
